...
<Section>
  <h1>contact me</h1>
  <p>
    <a class="text-sky-600 hover:text-sky-500" href="mailto:lars@aloft.software">send me an email</a
    >, or fill out this form, which sends me an email.
  </p>
  <p>can't wait to hear from you! &nbsp;&nbsp;-lars</p>
  ...
  form {
    ...
    .set {
      ...
      textarea {
        ...
        @apply focus:border-blue-300 transition-colors;
    ...
    button[type='submit'] {
      @apply p-2 border-2 border-sky-400 text-sky-500 bg-sky-50 self-center rounded;
      @apply hover:border-sky-600 hover:bg-white hover:text-sky-700 hover:shadow transition-all;
    }
  }
